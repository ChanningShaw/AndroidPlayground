...
class RobotWalk : AlgorithmModel() {

    override var name = "机器人漫步"

    override var title = "给定一个位置数组[1..N]表示n个位置，起始位置s，终止位置e，一个机器人开始位于s，它每次只能往左或者往右走一步，" +
            "如果它来到了位置1，那么它下一步只能往右走，同理，如果如果它来到了位置n，那么它下一步只能往左走，求机器人从s位置走到e位置共有多少种方法。"
